...
export default function LoadIntercordSettingsMenu(){
    ...
    SettingsMenuManager.addSettingRow("INTERCORD_ADVANCED", new SettingRowBuilder("Advanced").withIconName("ic_badge_staff").withRoute("Intercord Advanced", IntercordGeneralMenu));
}