...
function ReactDevTools(){
    ...
    return (
        <>
            ...
            <TableSwitchRow style={{marginTop: 16, padding: 2}} value={enabled} onValueChange={setEnabled} end={true} start={true} label={"Enable React Dev Tools"} subLabel={"Whether or not React Dev Tools should be loaded when the app starts."} />
