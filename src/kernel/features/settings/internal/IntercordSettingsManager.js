...
export default function LoadIntercordSettingsMenu(){
    ...
    SettingsMenuManager.addSettingRow("INTERCORD_PLUGINS", new SettingRowBuilder("Official Plugins").withIconName("PaperIcon").withRoute("Intercord Plugins", IntercordPluginsMenu));
